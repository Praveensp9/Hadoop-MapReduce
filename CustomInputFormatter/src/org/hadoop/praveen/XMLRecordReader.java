...
public class XMLRecordReader extends RecordReader<LongWritable,Text>{
    ...
    // Crucial method. Runs for first time. Initializes everything.
	@Override
	public void initialize(InputSplit inputSplit, TaskAttemptContext con) throws IOException, InterruptedException {
		...
		// Opening the file and reading the data from file.
	...
	public boolean nextKeyValue() throws IOException, InterruptedException {
		...
		key.set(curr_position);  // <-- Setting the Key Value
		
		
		value.clear(); // This is used to clear any values stored in Text variable value.
